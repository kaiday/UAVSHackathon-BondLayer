...
merchant has already been chosen (our Round 1 `ucp-findings.md`, Finding 3; git history, commit `074e51c`).
...
- Loyalty extends checkout, `dev.uip.shopping.loyalty` —
  our Round 1 `ucp-findings.md` (verified 30/08; git history, commit `074e51c`)
